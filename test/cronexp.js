    ...
    describe("CronExp", function () {
        describe("constructor()", function () {
            it('should support pattern"', function () {
                const cronexp = new CronExp("* 1 2-3 4,5 sat");
                assert.ok(cronexp.test(new Date("2000-04-01T01:00")));
                assert.ok(cronexp.test(new Date("2000-04-01T01:01")));
                assert.ok(cronexp.test(new Date("2000-04-02T01:00")));
                assert.ok(cronexp.test(new Date("2000-05-02T01:00")));
                assert.ok(cronexp.test(new Date("2001-04-02T01:00")));
                assert.ok(!cronexp.test(new Date("2000-04-01T00:59")));
                assert.ok(!cronexp.test(new Date("2000-04-01T02:00")));
                assert.ok(!cronexp.test(new Date("2000-04-04T01:00")));
                assert.ok(!cronexp.test(new Date("2000-05-01T01:00")));
                assert.ok(!cronexp.test(new Date("2001-04-01T01:00")));
            });
