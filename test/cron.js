...
describe("cron.js", function () {
    describe("Cron", function () {
        ...
        describe("bind()", function () {
            it("should pass thisArgs", function () {
            ...
            it("should pass thisArgs and arguments", function () {
                const fake = sinon.fake();
                const clock = sinon.useFakeTimers(new Date("2000-01-01T00:00"));
        ...
        describe("unbind()", function () {
            it("should reset thisArgs and arguments", function () {
                const fake = sinon.fake();
                const clock = sinon.useFakeTimers(new Date("2000-01-01T00:00"));
